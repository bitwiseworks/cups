        ...
        */
...
#ifdef __OS2__
        snprintf(cacrtfile, sizeof(cacrtfile), "/@unixroot/etc/letsencrypt/live/%s/fullchain.pem", hostname);
        snprintf(cakeyfile, sizeof(cakeyfile), "/@unixroot/etc/letsencrypt/live/%s/privkey.pem", hostname);
#else
        ...
        if ((access(cacrtfile, R_OK) || access(cakeyfile, R_OK)) && (hostptr = strchr(hostname, '.')) != NULL)
        {
          ...
          */
          ...
          {
#ifdef __OS2__
            snprintf(cacrtfile, sizeof(cacrtfile), "/@unixroot/etc/letsencrypt/live/%s/fullchain.pem", hostptr);
            snprintf(cakeyfile, sizeof(cakeyfile), "/@unixroot/etc/letsencrypt/live/%s/privkey.pem", hostptr);
#else
...
#ifdef __OS2__
        snprintf(cacrtfile, sizeof(cacrtfile), "/@unixroot/etc/letsencrypt/live/%s/fullchain.pem", tls_common_name);
        snprintf(cakeyfile, sizeof(cakeyfile), "/@unixroot/etc/letsencrypt/live/%s/privkey.pem", tls_common_name);
#else
