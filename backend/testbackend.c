     ...
     char *argv[])			/* I - Command-line arguments */
{
  ...
  */
  ...
  char dontblock = 1;
  os2_ioctl(back_fds[0], FIONBIO, &dontblock, sizeof(dontblock));
  os2_ioctl(back_fds[1], FIONBIO, &dontblock, sizeof(dontblock));
#endif
...
#ifdef __OS2__ //on os/2 fcntl sometimes fails to set nonblocking/blocking
  os2_ioctl(side_fds[0], FIONBIO, &dontblock, sizeof(dontblock));
  os2_ioctl(side_fds[1], FIONBIO, &dontblock, sizeof(dontblock));
#endif
